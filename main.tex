...
\begin{figure}[!t]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{(a) The two-piece hexagonal Cu/Ta/Nb cavity after sputter deposition of the Ta diffusion barrier and Nb film. (b) Laser-scanning confocal microscope (Veeco) image of the sputtered Nb surface, confirming the substrate was inspected for roughness after deposition.}
    \label{fig:cavity}
\end{figure}
